    ...
    <section className="py-20 bg-gradient-to-b from-background to-secondary dark:from-background dark:to-secondary/30">
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        <div className="flex justify-center mb-12 w-full">
          <div className="relative rounded-xl overflow-hidden shadow-xl transform transition-all hover:scale-105 duration-300 mx-auto max-w-xs w-full">
            <img
        ...
        {/* Cards below profile picture */}
        <div className="flex flex-col items-center w-full gap-8">
          <div className="bg-card dark:bg-card rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 max-w-[1500px] w-full mx-auto">
